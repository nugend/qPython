...
try:
    ...
    PANDAS_EXPRESSIONS = OrderedDict(
        (
            ...
            (
                b"``quick``fox",
                {
                    "data": pandas.Series(numpy.array([qnull(QSYMBOL), numpy.string_("quick"), qnull(QSYMBOL), numpy.string_("fox")])),
            ...
            (
                ...
                {
                    "data": pandas.Series(
                        numpy.array([numpy.string_("the"), numpy.string_("quick"), numpy.string_("brown"), numpy.string_("fox")])
                    ),
                    "meta": MetaData(qtype=QSYMBOL_LIST),
                },
            ),
            ...
            (
                b"(0b;1b;0b)",
                {"data": pandas.Series(numpy.array([False, True, False], dtype=numpy.bool)), "meta": MetaData(qtype=QBOOL_LIST)},
            ),
            (b"(0x01;0x02;0xff)", {"data": pandas.Series(numpy.array([1, 2, 0xFF], dtype=numpy.int8)), "meta": MetaData(qtype=QBYTE_LIST)}),
            (b"(1h;2h;3h)", {"data": pandas.Series(numpy.array([1, 2, 3], dtype=numpy.int16)), "meta": MetaData(qtype=QSHORT_LIST)}),
            (b"(1h;0Nh;3h)", {"data": pandas.Series(numpy.array([1, numpy.nan, 3])), "meta": MetaData(qtype=QSHORT_LIST)}),
            (b"1 2 3", {"data": pandas.Series(numpy.array([1, 2, 3], dtype=numpy.int64)), "meta": MetaData(qtype=QLONG_LIST)}),
            (b"1 0N 3", {"data": pandas.Series([1, numpy.nan, 3]), "meta": MetaData(qtype=QLONG_LIST)}),
            (b"(1i;2i;3i)", {"data": pandas.Series(numpy.array([1, 2, 3], dtype=numpy.int32)), "meta": MetaData(qtype=QINT_LIST)}),
            (b"(1i;0Ni;3i)", {"data": pandas.Series(numpy.array([1, numpy.nan, 3])), "meta": MetaData(qtype=QINT_LIST)}),
            (b"(1j;2j;3j)", {"data": pandas.Series(numpy.array([1, 2, 3], dtype=numpy.int64)), "meta": MetaData(qtype=QLONG_LIST)}),
            (b"(1j;0Nj;3j)", {"data": pandas.Series(numpy.array([1, numpy.nan, 3])), "meta": MetaData(qtype=QLONG_LIST)}),
            (b"(5.5e; 8.5e)", {"data": pandas.Series(numpy.array([5.5, 8.5]), dtype=numpy.float32), "meta": MetaData(qtype=QFLOAT_LIST)}),
            (
                b"(5.5e; 0Ne)",
                {"data": pandas.Series(numpy.array([5.5, numpy.nan]), dtype=numpy.float32), "meta": MetaData(qtype=QFLOAT_LIST)},
            ),
            (b"3.23 6.46", {"data": pandas.Series(numpy.array([3.23, 6.46])), "meta": MetaData(qtype=QDOUBLE_LIST)}),
            (b"3.23 0n", {"data": pandas.Series(numpy.array([3.23, numpy.nan])), "meta": MetaData(qtype=QDOUBLE_LIST)}),
            (
                b"(2001.01m; 0Nm)",
                {
                    "data": pandas.Series(numpy.array([numpy.datetime64("2001-01"), numpy.datetime64("NaT")], dtype="datetime64[M]")),
            ...
            (
                ...
                {
                    "data": pandas.Series(numpy.array([numpy.datetime64("2000-01-04T05:36:57.600", "ms"), numpy.datetime64("nat", "ms")])),
            ...
            (
                b"12:01 0Nu",
                {
                    "data": pandas.Series(numpy.array([numpy.timedelta64(721, "m"), numpy.timedelta64("nat", "m")])),
            ...
            (
                b"12:05:00 0Nv",
                {
                    "data": pandas.Series(numpy.array([numpy.timedelta64(43500, "s"), numpy.timedelta64("nat", "s")])),
            ...
            (
                b"12:04:59.123 0Nt",
                {
                    "data": pandas.Series(numpy.array([numpy.timedelta64(43499123, "ms"), numpy.timedelta64("nat", "ms")])),
            ...
            (
                ...
                {
                    "data": pandas.Series(numpy.array([numpy.datetime64("2000-01-04T05:36:57.600", "ns"), numpy.datetime64("nat", "ns")])),
            ...
            (
                ...
                {
                    "data": pandas.Series(numpy.array([numpy.timedelta64(20217600000000, "ns"), numpy.timedelta64("nat", "ns")])),
            ...
            (
                ...
                QDictionary(
                    [numpy.int64(1), numpy.int16(2), numpy.float64(3.234), b"4"],
                    [
                        numpy.string_("one"),
                        qlist(numpy.array([2, 3], dtype=numpy.int64), qtype=QLONG_LIST),
                        b"456",
            ...
            (
                b"flip `abc`def!(1 2 3; 4 5 6)",
                {
                    "data": pandas.DataFrame(
                        OrderedDict(
                            (
                                ("abc", pandas.Series(numpy.array([1, 2, 3], dtype=numpy.int64))),
            ...
            (
                b"flip `name`iq!(`Dent`Beeblebrox`Prefect;98 42 126)",
                {
                    "data": pandas.DataFrame(
                        OrderedDict(
                            (
                                ("name", pandas.Series(["Dent", "Beeblebrox", "Prefect"], dtype=numpy.string_)),
            ...
            (
                b'1#([] sym:`x`x`x;str:"  a")',
                {
                    "data": pandas.DataFrame(
                        OrderedDict(
                            (
                                ("sym", pandas.Series(["x"], dtype=numpy.string_)),
            ...
            (
                ...
                {
                    "data": pandas.DataFrame(
                        OrderedDict((("sym", pandas.Series(["x"], dtype=numpy.string_)), ("str", pandas.Series(["a"], dtype=numpy.str)),))
                    ),
                    "meta": MetaData(**{"qtype": QTABLE, "sym": QSYMBOL_LIST, "str": QSTRING}),
                    "single_char_strings": True,
                },
            ...
            (
                b'2#([] sym:`x`x`x`x;str:"  aa")',
                {
                    "data": pandas.DataFrame(
                        OrderedDict(
                            (
                                ("sym", pandas.Series(["x", "x"], dtype=numpy.string_)),
                                ("str", pandas.Series([" ", " "], dtype=numpy.str).replace(b" ", numpy.nan)),
                            )
                        )
                    ),
            ...
            (
                b"([] sc:1 2 3; nsc:(1 2; 3 4; 5 6 7))",
                {
                    "data": pandas.DataFrame(
                        OrderedDict(
                            (
                                ("sc", pandas.Series(numpy.array([1, 2, 3], dtype=numpy.int64))),
                                (
                                    "nsc",
                                    [
                                        pandas.Series(numpy.array([1, 2], dtype=numpy.int64)),
                                        pandas.Series(numpy.array([3, 4], dtype=numpy.int64)),
                                        pandas.Series(numpy.array([5, 6, 7], dtype=numpy.int64)),
                                    ],
                                ),
                            )
                        )
                            ...
                            (
                                ...
                                (
                                    ...
                                    [
                                        pandas.Series(numpy.array([1, 2], dtype=numpy.int64)),
                                        pandas.Series(numpy.array([3, 4], dtype=numpy.int64)),
                                        pandas.Series(numpy.array([5, 6], dtype=numpy.int64)),
                                    ],
                                ),
                            )
                        )
            ...
            (
                b"([] name:`symbol$(); iq:`int$())",
                {
                    "data": pandas.DataFrame(
                        OrderedDict(
                            (
                                ("name", pandas.Series(numpy.array([], dtype=numpy.string_))),
                        ...
                        OrderedDict(
                            (
                                ...
                                (
                                    ...
                                    pandas.Series(
                                        numpy.array(
                                            [numpy.datetime64("2001-01-01"), numpy.datetime64("2000-05-01"), numpy.datetime64("NaT")],
                                            dtype="datetime64[D]",
                                        )
                                    ),
                                ),
            ...
            (
                b"([eid:1001 1002 1003] pos:`d1`d2`d3;dates:(2001.01.01;2000.05.01;0Nd))",
                {
                    "data": pandas.DataFrame(
                        OrderedDict(
                            (
                                ("eid", pandas.Series(numpy.array([1001, 1002, 1003], dtype=numpy.int64))),
                                ("pos", pandas.Series(numpy.array(["d1", "d2", "d3"], dtype=numpy.string_))),
                                (
                                    "dates",
                                    pandas.Series(
            ...
            (
                ...
                {
                    "data": pandas.DataFrame(
                        {"k": numpy.array([1, 2, 3], dtype=numpy.int64), "v": numpy.array(["a", "b", "c"], dtype=numpy.string_)}
                    ),
    ...
    PANDAS_EXPRESSIONS_ALT = OrderedDict(
        (
            (
                b'("quick"; "brown"; "fox"; "jumps"; "over"; "a lazy"; "dog")',
                {"data": pandas.Series(["quick", "brown", "fox", "jumps", "over", "a lazy", "dog"]), "meta": MetaData(qtype=QSTRING_LIST)},
            ),
        )
    )
            ...
            try:
                ...
                if isinstance(value, dict):
                    ...
                    if not "compare_meta" in value or value["compare_meta"]:
                        assert (
                            value["meta"].as_dict() == result.meta.as_dict()
                        ), "deserialization failed qtype: %s, expected: %s actual: %s" % (query, value["meta"], result.meta)
