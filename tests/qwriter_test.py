...
EXPRESSIONS = OrderedDict(
    (
        ...
        (
            b"(2001.01m; 0Nm)",
            (
                qlist(numpy.array([to_raw_qtemporal(numpy.datetime64("2001-01", "M"), QMONTH), qnull(QMONTH)]), qtype=QMONTH_LIST),
                qlist(numpy.array([12, qnull(QMONTH)]), qtype=QMONTH_LIST),
                qlist(
                    array_to_raw_qtemporal(
                        numpy.array([numpy.datetime64("2001-01", "M"), numpy.datetime64("NaT", "M")]), qtype=QMONTH_LIST
                    ),
                    qtype=QMONTH_LIST,
                ),
        ...
        (b"2001.01m", (qtemporal(numpy.datetime64("2001-01", "M"), qtype=QMONTH), numpy.datetime64("2001-01", "M"))),
        (
            b"0Nm",
            (qtemporal(qnull(QMONTH), qtype=QMONTH), qtemporal(numpy.datetime64("NaT", "M"), qtype=QMONTH), numpy.datetime64("NaT", "M")),
        ),
        (
            ...
            (
                qlist(
                    numpy.array(
                        [
                            to_raw_qtemporal(numpy.datetime64("2001-01-01", "D"), qtype=QDATE),
                            to_raw_qtemporal(numpy.datetime64("2000-05-01", "D"), qtype=QDATE),
                            qnull(QDATE),
                        ]
                    ),
                    qtype=QDATE_LIST,
                ...
                qlist(
                    array_to_raw_qtemporal(
                        numpy.array(
                            [numpy.datetime64("2001-01-01", "D"), numpy.datetime64("2000-05-01", "D"), numpy.datetime64("NaT", "D")]
                        ),
                        qtype=QDATE_LIST,
                    ),
                    qtype=QDATE_LIST,
                ...
                qlist(
                    numpy.array(
                        [numpy.datetime64("2001-01-01"), numpy.datetime64("2000-05-01"), numpy.datetime64("NaT")], dtype="datetime64[D]"
                    ),
                    qtype=QDATE_LIST,
                ),
                numpy.array(
        ...
        (b"2001.01.01", (qtemporal(numpy.datetime64("2001-01-01", "D"), qtype=QDATE), numpy.datetime64("2001-01-01", "D"))),
        (
            b"0Nd",
            (qtemporal(qnull(QDATE), qtype=QDATE), qtemporal(numpy.datetime64("NaT", "D"), qtype=QDATE), numpy.datetime64("NaT", "D")),
        ),
        (
            ...
            (
                ...
                qlist(
                    numpy.array([numpy.datetime64("2000-01-04T05:36:57.600", "ms"), numpy.datetime64("nat", "ms")]), qtype=QDATETIME_LIST
                ),
                numpy.array([numpy.datetime64("2000-01-04T05:36:57.600", "ms"), numpy.datetime64("nat", "ms")]),
            ),
        ),
        ...
        (
            ...
            (
                ...
                qlist(
                    array_to_raw_qtemporal(numpy.array([numpy.timedelta64(721, "m"), numpy.timedelta64("nat", "m")]), qtype=QMINUTE_LIST),
                    qtype=QMINUTE_LIST,
                ),
        ...
        (b"12:01", (qtemporal(numpy.timedelta64(721, "m"), qtype=QMINUTE), numpy.timedelta64(721, "m"))),
        (
            b"0Nu",
            (
                qtemporal(qnull(QMINUTE), qtype=QMINUTE),
        ...
        (
            ...
            (
                ...
                qlist(
                    array_to_raw_qtemporal(numpy.array([numpy.timedelta64(43500, "s"), numpy.timedelta64("nat", "s")]), qtype=QSECOND_LIST),
                    qtype=QSECOND_LIST,
                ),
        ...
        (b"12:05:00", (qtemporal(numpy.timedelta64(43500, "s"), qtype=QSECOND), numpy.timedelta64(43500, "s"))),
        (
            b"0Nv",
            (
                qtemporal(qnull(QSECOND), qtype=QSECOND),
        ...
        (b"12:04:59.123", (qtemporal(numpy.timedelta64(43499123, "ms"), qtype=QTIME), numpy.timedelta64(43499123, "ms"))),
        (
            b"0Nt",
            (qtemporal(qnull(QTIME), qtype=QTIME), qtemporal(numpy.timedelta64("NaT", "ms"), qtype=QTIME), numpy.timedelta64("NaT", "ms")),
        ),
        (
            ...
            (
                ...
                qlist(
                    numpy.array([numpy.datetime64("2000-01-04T05:36:57.600", "ns"), numpy.datetime64("nat", "ns")]), qtype=QTIMESTAMP_LIST
                ),
                numpy.array([numpy.datetime64("2000-01-04T05:36:57.600", "ns"), numpy.datetime64("nat", "ns")]),
            ),
        ),
        ...
        (
            b"0Np",
            (
                qtemporal(qnull(QTIMESTAMP), qtype=QTIMESTAMP),
        ...
        (
            ...
            (
                qlist(numpy.array([long(20217600000000), qnull(QTIMESPAN)]), qtype=QTIMESPAN_LIST),
                qlist(
                    array_to_raw_qtemporal(
                        numpy.array([numpy.timedelta64(20217600000000, "ns"), numpy.timedelta64("nat", "ns")]), qtype=QTIMESPAN_LIST
                    ),
        ...
        (b"0D05:36:57.600", (qtemporal(numpy.timedelta64(20217600000000, "ns"), qtype=QTIMESPAN), numpy.timedelta64(20217600000000, "ns"))),
        (
            b"0Nn",
            (
                qtemporal(qnull(QTIMESPAN), qtype=QTIMESPAN),
        ...
        (b'"0"', "0"),
        (b'"abc"', ("abc", numpy.array(list("abc"), dtype="S"))),
        ...
        (
            b"(0b;1b;0b)",
            (
                numpy.array([False, True, False], dtype=numpy.bool_),
        ...
        (
            b"(0x01;0x02;0xff)",
            (
                numpy.array([0x01, 0x02, 0xFF], dtype=numpy.byte),
        ...
        (
            b"(5.5e; 8.5e)",
            (
                numpy.array([5.5, 8.5], dtype=numpy.float32),
        ...
        (
            b"3.23 6.46",
            (
                numpy.array([3.23, 6.46], dtype=numpy.float64),
        ...
        (
            ...
            [
                ...
                "456",
                [numpy.int64(7), qlist(numpy.array([8, 9], dtype=numpy.int64), qtype=QLONG_LIST)],
            ],
        ),
        (
            b"`jumps`over`a`lazy`dog",
            (
                numpy.array(["jumps", "over", "a", "lazy", "dog"], dtype=numpy.string_),
        ...
        (
            ...
            numpy.array([numpy.string_("the"), numpy.string_("quick"), numpy.string_("brown"), numpy.string_("fox")], dtype=numpy.object),
        ),
        (
            b"``quick``fox",
            qlist(
                numpy.array([qnull(QSYMBOL), numpy.string_("quick"), qnull(QSYMBOL), numpy.string_("fox")], dtype=numpy.object),
                qtype=QSYMBOL_LIST,
            ),
        ),
        ...
        (
            b"(enlist `a)!(enlist 1)",
            (
                QDictionary(qlist(numpy.array(["a"]), qtype=QSYMBOL_LIST), qlist(numpy.array([1], dtype=numpy.int64), qtype=QLONG_LIST)),
                QDictionary(qlist(numpy.array(["a"]), qtype=QSYMBOL_LIST), qlist(numpy.array([1]), qtype=QLONG_LIST)),
            ),
        ),
        (
            b"1 2!`abc`cdefgh",
            QDictionary(
                qlist(numpy.array([1, 2], dtype=numpy.int64), qtype=QLONG_LIST), qlist(numpy.array(["abc", "cdefgh"]), qtype=QSYMBOL_LIST)
            ),
        ),
        (
            ...
            QDictionary(
                ...
                qtable(
                    qlist(numpy.array(["one", "two"]), qtype=QSYMBOL_LIST),
                    [qlist(numpy.array([1, 2, 3]), qtype=QLONG_LIST), qlist(numpy.array([4, 5, 6]), qtype=QLONG_LIST)],
                ),
            ),
        ),
        (b"(`x`y!(`a;2))", QDictionary(qlist(numpy.array(["x", "y"]), qtype=QSYMBOL_LIST), [numpy.string_("a"), numpy.int64(2)])),
        (
        ...
        (
            ...
            QDictionary(
                [numpy.int64(1), numpy.int16(2), numpy.float64(3.234), "4"],
                [
                    numpy.string_("one"),
                    qlist(numpy.array([2, 3], dtype=numpy.int64), qtype=QLONG_LIST),
                    "456",
        ...
        (
            ...
            QDictionary(
                ...
                [
                    [numpy.int64(1), numpy.float64(3.234), numpy.int64(3)],
                    QDictionary(qlist(numpy.array(["x", "y"]), qtype=QSYMBOL_LIST), [numpy.string_("a"), numpy.int64(2)]),
                    numpy.float32(5.5),
                ],
            ),
        ),
        (
            ...
            (
                qtable(
                    qlist(numpy.array(["abc", "def"]), qtype=QSYMBOL_LIST),
                    [
                        qlist(numpy.array([1, 2, 3], dtype=numpy.int64), qtype=QLONG_LIST),
                ...
                qtable(qlist(["abc", "def"], qtype=QSYMBOL_LIST), [qlist([1, 2, 3], qtype=QLONG_LIST), qlist([4, 5, 6], qtype=QLONG_LIST)]),
                qtable(
                    qlist(["abc", "def"], qtype=QSYMBOL_LIST),
                    [qlist([1, 2, 3]), qlist([4, 5, 6])],
                    **{"abc": QLONG_LIST, "def": QLONG_LIST}
                ),
                qtable(["abc", "def"], [[1, 2, 3], [4, 5, 6]], **{"abc": QLONG, "def": QLONG}),
            ),
        ),
        (
            ...
            (
                qtable(
                    qlist(numpy.array(["name", "iq"]), qtype=QSYMBOL_LIST),
                    [
                ...
                qtable(
                    ...
                    [qlist(["Dent", "Beeblebrox", "Prefect"], qtype=QSYMBOL_LIST), qlist([98, 42, 126], qtype=QLONG_LIST)],
                ),
                qtable(
                    qlist(["name", "iq"], qtype=QSYMBOL_LIST),
                    [qlist(["Dent", "Beeblebrox", "Prefect"]), qlist([98, 42, 126])],
                    name=QSYMBOL,
                    iq=QLONG,
                ),
                qtable(["name", "iq"], [["Dent", "Beeblebrox", "Prefect"], [98, 42, 126]], name=QSYMBOL, iq=QLONG),
                qtable(["name", "iq"], [["Dent", "Beeblebrox", "Prefect"], [98, 42, 126]], **{"name": QSYMBOL, "iq": QLONG}),
            ),
        ),
        (
            ...
            qtable(
                qlist(numpy.array(["name", "iq", "grade"]), qtype=QSYMBOL_LIST),
                [
                    qlist(numpy.array(["Dent", "Beeblebrox", "Prefect"]), qtype=QSYMBOL_LIST),
                    qlist(numpy.array([98, 42, 126]), qtype=QLONG_LIST),
                    "a c",
        ...
        (
            ...
            qtable(
                qlist(numpy.array(["name", "iq", "misc"]), qtype=QSYMBOL_LIST),
                [
                    qlist(numpy.array(["Dent", "Beeblebrox", "Prefect"]), qtype=QSYMBOL_LIST),
                    qlist(numpy.array([98, 42, 126]), qtype=QLONG_LIST),
                    qlist(
                        numpy.array(
                            [
                                ...
                                long(160),
                                qtemporal(numpy.datetime64("1979-10-12", "D"), qtype=QDATE),
                            ]
                        ),
                        qtype=QGENERAL_LIST,
                    ),
        ...
        (
            ...
            (
                qtable(
                    qlist(numpy.array(["sc", "nsc"]), qtype=QSYMBOL_LIST),
                    [
                        qlist(numpy.array([1, 2, 3], dtype=numpy.int64), qtype=QLONG_LIST),
                        [
                ...
                qtable(
                    qlist(["sc", "nsc"], qtype=QSYMBOL_LIST),
                    [
                        qlist([1, 2, 3], qtype=QLONG_LIST),
                        [qlist([1, 2], qtype=QLONG_LIST), qlist([3, 4], qtype=QLONG_LIST), qlist([5, 6, 7], qtype=QLONG_LIST)],
                    ],
                ),
            ),
        ),
        ...
        (
            ...
            {
                "data": qtable(
                    qlist(numpy.array(["sym", "str"]), qtype=QSYMBOL_LIST),
                    [qlist(numpy.array(["x"], dtype=numpy.string_), qtype=QSYMBOL_LIST), b" "],
                ),
        ...
        (
            b'-1#([] sym:`x`x`x;str:"  a")',
            {
                "data": qtable(
                    qlist(numpy.array(["sym", "str"]), qtype=QSYMBOL_LIST),
                    [qlist(numpy.array(["x"], dtype=numpy.string_), qtype=QSYMBOL_LIST), b"a"],
                ),
                "single_char_strings": True,
            },
        ),
        (
            ...
            qtable(
                qlist(numpy.array(["sym", "str"]), qtype=QSYMBOL_LIST),
                [qlist(numpy.array(["x", "x"], dtype=numpy.string_), qtype=QSYMBOL_LIST), b"  "],
            ),
        ),
        (
            b'-2#([] sym:`x`x`x`x;str:"  aa")',
            qtable(
                qlist(numpy.array(["sym", "str"]), qtype=QSYMBOL_LIST),
                [qlist(numpy.array(["x", "x"], dtype=numpy.string_), qtype=QSYMBOL_LIST), b"aa"],
            ),
        ),
        (
            ...
            (
                ...
                qtable(
                    qlist(numpy.array(["name", "iq"]), qtype=QSYMBOL_LIST),
                    [qlist(numpy.array([]), qtype=QSYMBOL_LIST), qlist(numpy.array([]), qtype=QINT_LIST)],
                ),
                qtable(qlist(["name", "iq"], qtype=QSYMBOL_LIST), [qlist([], qtype=QSYMBOL_LIST), qlist([], qtype=QINT_LIST)]),
            ),
        ),
        (
            ...
            (
                qtable(
                    qlist(numpy.array(["pos", "dates"]), qtype=QSYMBOL_LIST),
                    [
        ...
        (
            ...
            QKeyedTable(
                qtable(qlist(numpy.array(["eid"]), qtype=QSYMBOL_LIST), [qlist(numpy.array([1001, 1002, 1003]), qtype=QLONG_LIST)]),
                qtable(
                    qlist(numpy.array(["pos", "dates"]), qtype=QSYMBOL_LIST),
                    [
                        qlist(numpy.array(["d1", "d2", "d3"]), qtype=QSYMBOL_LIST),
    ...
    for query, value in iter(EXPRESSIONS.items()):
        ...
        if isinstance(value, tuple):
            for obj in value:
                ...
                assert serialized == BINARY[query].lower(), "serialization failed: %s, expected: %s actual: %s" % (
                    query,
                    BINARY[query].lower(),
                    serialized,
                )
